...
const services: ServiceItem[] = [
  {
    id: 1,
    title: "General Medicine & Tele-OPD",
    category: "प्राथमिक आरोग्य केंद्र (PHC OPD)",
    icon: (
  ...
  {
    id: 2,
    title: "Maternal ANC/PNC & Child Care",
    category: "मातृ व बाल संगोपन (MCH)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    category: "निरीक्षण कक्ष (Observation Bed)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 4,
    title: "Emergency Triage & 104/108 Ambulance",
    category: "आपत्कालीन सेवा (24x7 Emergency)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    category: "सोनोग्राफी व तपासणी (USG Clinic)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 6,
    title: "Digital Radiology & X-Ray",
    category: "डिजिटल क्ष-किरण (X-Ray Facility)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 7,
    title: "NCD Staging & Point-of-Care ECG",
    category: "मधुमेह व रक्तदाब (NCD Screening)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  {
    id: 8,
    title: "Doorstep ASHA Outreach & Kiosks",
    category: "आशा ग्राम आरोग्य सेवा (Outreach)",
    icon: (
      <svg className="w-6 h-6 text-[#0E4A43]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#E5F973] text-slate-950 text-xs sm:text-sm font-bold tracking-tight">
            ...
            <span>Comprehensive Public Services</span>
          </div>
          ...
          <p className="text-slate-600 text-xs sm:text-sm leading-relaxed max-w-xl">
            Essential point-of-care services provided across Maharashtra&apos;s primary healthcare network to eliminate specialist gaps and travel burdens.
          </p>
